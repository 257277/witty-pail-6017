...
let url = "http://localhost:4500/shoes"
let btns = [];
const cloth = async () => {
    ...
    if (res.ok) {
        ...
        display(arr);
        btns = document.querySelectorAll("#shoes button");
        addcart(btns, arr);
    }
}
...
const display = (arr) => {
    ...
    document.querySelector("#shoes").innerHTML = allgroup;
...
document.querySelector("#Loafers").addEventListener("click", () => {
    shoes.push("Loafers")
})
document.querySelector("#Sandals").addEventListener("click", () => {
    shoes.push("Sandals")
})
document.querySelector("#Shoes").addEventListener("click", () => {
    shoes.push("Shoes")
})
document.querySelector("#Sneakers").addEventListener("click", () => {
    shoes.push("Sneakers")
})
document.querySelector("#Boots").addEventListener("click", () => {
    shoes.push("Boots")
})
...
document.querySelector("#sfltrbtn").addEventListener("click", () => {
